...
function enqueue_scripts() {
	...
	wp_enqueue_script(
		'altis-accelerate',
		Utils\get_asset_url( 'accelerate.js' ),
		[
			'altis-accelerate-polyfill.io',
		],
		null,
			...
			wp_json_encode(
				[
					...
					'Config' => [
						...
						'PinpointEndpoint' => defined( 'ALTIS_ANALYTICS_PINPOINT_ENDPOINT' ) ? ALTIS_ANALYTICS_PINPOINT_ENDPOINT : 'https://eu.accelerate.altis.cloud/log',
	...
	$wp_scripts->add_data( 'altis-accelerate', 'async', true );
